...
public:
    ...
    /// - __cornersOnly__: Sharpen corners of interior boundaries only,
    ...
    /// at points with at least one interior boundary corner or
    /// only one interior boundary edge (a dart)
    /// - __boundaries__: Piecewise linear along interior boundaries, smooth
    /// interior
