...
struct UsdGeomTokensType {
    ...
    /// \brief "uniform"
    /// 
    /// Possible value for UsdGeomPrimvar::SetInterpolation. One value remains constant for each segment of the primitive (e.g. a _face_ for meshes).
    ...
    /// \brief "varying"
    /// 
    /// Possible value for UsdGeomPrimvar::SetInterpolation. Values associated with points are linearly interpolated over each segment using the points on the boundary of that segment.
